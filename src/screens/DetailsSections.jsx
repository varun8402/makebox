const DetailsSections = () => {
  return (
    <div className = "mt-10 bg-black py-10 px-10 flex flex-col gap-5 pb-30">
        <div >
            <h1 className = "font-md text-[#898989] text-center mt-10 " data-aos="fade-up">MAKEBOX</h1>
            <h1 className = "font-bold text-7xl text-white text-center mt-8" data-aos="fade-up">Details to notice.</h1>
            <div className="flex gap-60">
                ...
                <ul className = "list-disc text-left space-y-2 text-2xl flex flex-col gap-12">
                    <li data-aos="fade-up"><span  className="font-semibold">Seamless Interaction</span> – Intuitive tactile controls blended with digital precision for a fluid creative workflow.</li>
                    <li className="ml-20" data-aos="fade-up"><span className="font-semibold">Unlimited Customization </span>– Fully adaptable interface and controls tailored to every creative style.</li>
                    <li data-aos="fade-up"><span  className="font-semibold">Powerful Performance </span>– Engineered with advanced hardware and software integration for professional-grade editing.</li>
                    <li className="ml-20" data-aos="fade-up"><span  className="font-semibold">Creative Freedom</span> – Unlock limitless possibilities with tools designed to push boundaries and bring any vision to life.</li>
                </ul>
            </div>
            </div>
