...
const SwitchSection = () => {
    return (
        <div className="mt-19  " data-aos="fade-up">
            ...
            <div className = "flex flex-col  md:flex-row gap-20 justify-between items-center mt-15 px-30 ">
            ...
            <h2 className = "text-white text-xl font-thin px-4  "><span className = "font-semibold">Cherry MX  <span className = "text-[#F96F6F]">Red</span></span>: <br />This switch color is known for its smooth and linear key press. It  requires a light touch and has no tactile bump or audible click. Cherry  MX Red switches are popular among gamers and typists who prefer a quiet  and effortless typing experience. Imagine typing on a keyboard that glides effortlessly under your fingers, making it ideal for rapid  keystrokes in gaming or typing sessions.</h2>
            </div>
            <div className = "max-w-lg text-center">
             <h2 className = "text-white text-xl font-thin px-4 "><span className = "font-semibold">Cherry MX  <span className = "text-[#2E83F3]">Blue</span></span>:<br /> If you enjoy tactile and clicky feedback with each key press, Cherry MX  Blue switches are the way to go. These switches have a distinct tactile  bump and produce a satisfying click sound, making them a favorite among typists who appreciate the audible feedback. The tactile bump provides a slight resistance, giving you a sense of confirmation with every keystroke.</h2>
            </div>
            <div className = "max-w-lg text-center">
             <h2 className = "text-white text-xl font-thin"><span className = "font-semibold">Cherry MX  <span className = "text-[#8E5726]">Brown</span></span>:<br /> If you enjoy tactile and clicky feedback with each key press, Cherry MX  Blue switches are the way to go. These switches have a distinct tactile  bump and produce a satisfying click sound, making them a favorite among typists who appreciate the audible feedback. The tactile bump provides a slight resistance, giving you a sense of confirmation with every keystroke.</h2>
             </div>
            </div>
        </div>
    );
