        ...
        <div className="flex items-center border-l-2 border-black pl-8 md:pl-12 h-40">
          <div className="flex flex-col sm:flex-row gap-y-4 sm:gap-x-12 md:gap-x-16">
            <div className="flex flex-col space-y-3">
              ...
              <a href="https://www.instagram.com/afterthought.flac.raw/" className="text-xs underline font-bold tracking-widest">INSTAGRAM</a>
              <a href="https://www.behance.net/fitoore1" className="text-xs underline font-bold tracking-widest">BEHANCE</a>
            </div>
            {/* Column 2 */}
            <div className="flex flex-col space-y-3">
              <p className="text-xs font-semibold tracking-widest whitespace-nowrap">VARUN MARWAH (FRONT-END DEV.)</p>
              <a href="https://www.linkedin.com/in/varun-marwah/" className="text-xs underline font-bold tracking-widest">LINKEDIN</a>
              <a href="https://github.com/varun8402" className="text-xs underline font-bold tracking-widest">GITHUB</a>
            </div>
          </div>
        </div>
      </div>
